...
const redisConnectionString = config.DEVELOPMENT_MODE === 'prod' ? config.MORALIS_API_KEY_STREAMS_PROD : config.REDIS_CONNECTION_STRING_DEV;

const redisClient = new RedisCacheAdapter({ url: redisConnectionString });
