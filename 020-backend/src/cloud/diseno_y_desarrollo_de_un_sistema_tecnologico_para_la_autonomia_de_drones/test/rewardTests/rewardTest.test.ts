...
describe('Reward tests', () => {
  ...
  let createRewardResponse: any;

  beforeAll(async () => {
    sessionToken = await loginUser(request, app);

    createRewardResponse = await request(app)
  ...
  describe('Update Reward', () => {
    let updateRewardResponse: any;
    beforeAll(async () => {
      updateRewardResponse = await request(app)
  ...
  describe('Get All Rewards', () => {
    let getAllRewardsResponse: any;
    beforeAll(async () => {
      getAllRewardsResponse = await request(app)
  ...
  describe('Get Reward By Id', () => {
    let getRewardResponse: any;
    beforeAll(async () => {
      getRewardResponse = await request(app)
  ...
  describe('Delete Reward', () => {
    let deleteRewardResponse: any;
    beforeAll(async () => {
      deleteRewardResponse = await request(app)
