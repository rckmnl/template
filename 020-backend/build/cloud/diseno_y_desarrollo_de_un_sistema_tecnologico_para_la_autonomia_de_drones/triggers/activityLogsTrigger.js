...
const validateActivityLogs_1 = require("../validators/validateActivityLogs");
node_1.default.Cloud.beforeSave('activitylogs', async (request) => {
    try {
        ...
        const error = await (0, validateActivityLogs_1.validateActivityLogs)(data, isNew);
        if (error) {
...
//# sourceMappingURL=activityLogsTrigger.js.map