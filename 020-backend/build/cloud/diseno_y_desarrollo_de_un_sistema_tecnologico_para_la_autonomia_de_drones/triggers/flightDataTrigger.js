...
const validateFlightData_1 = require("../validators/validateFlightData");
node_1.default.Cloud.beforeSave('flightdata', async (request) => {
    try {
        ...
        const error = await (0, validateFlightData_1.validateFlightData)(data, isNew);
        if (error) {
...
//# sourceMappingURL=flightDataTrigger.js.map